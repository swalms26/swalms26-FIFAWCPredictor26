...
const WC2026_SQUADS = {
  ...
  "Sweden": ["Victor Lindelof","Gustaf Lagerbielke","Isak Hien","Gabriel Gudmundsson","Herman Johansson","Lucas Bergvall","Daniel Svensson","Benjamin Nygren","Anthony Elanga","Ken Sema","Albin Ekdal","Carl Starfelt","Mikael Karlstrom","Yasin Ayari","Mattias Svanberg","Eric Smith","Alexander Bernhardsson","Christos Zeneli","Robin Stroud","Marcus Nilsson","Mohammed Ali","Alexander Isak","Viktor Gyokeres"],
  ...
  "Spain": ["Dani Carvajal","Aymeric Laporte","Robin Le Normand","Alejandro Grimaldo","Álex Baena","Pau Cubarsí","Daniel Vivian","Pedri","Fabián Ruiz","Rodri","Martín Zubimendi","Dani Olmo","Mikel Merino","Mikel Oyarzabal","Lamine Yamal","Nico Williams","Álvaro Morata","Bryan Gil","Ferran Torres","Yeremy Pino","Ayoze Pérez"],
  ...
  "Uruguay": ["Jose Maria Gimenez","Santiago Caceres","Ronald Araujo","Manuel Ugarte","Rodrigo Bentancur","Nicolas De La Cruz","Federico Valverde","Darwin Nunez","Giorgian De Arrascaeta","Facundo Pellistri","Guillermo Varela","Agustin Canobbio","Emiliano Martinez","Mathias Olivera","Marcelo Vina","Brian Rodriguez","Rodrigo Aguirre","Maximiliano Araujo","Federico Vinas","Jose Piquerez","Santiago Bueno","Jose Maria Sanabria","Rodrigo Zalazar"],
